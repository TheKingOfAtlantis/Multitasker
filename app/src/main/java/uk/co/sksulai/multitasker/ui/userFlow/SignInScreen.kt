...
@Composable fun SignInScreen(
    ...
    Scaffold(
        ...
        val signUpAction = { emailField: FieldState, passwordField: FieldState ->
            action(userViewModel::create, emailField, passwordField, "SignUp")
        }
        val signInAction = { emailField: FieldState, passwordField: FieldState ->
            action(userViewModel::authenticate, emailField, passwordField, "CalendarView")
        }
