...
@Composable fun SignInScreen(emailIn: String = "", pwdIn: String = "") {
    ...
    Scaffold(
        ...
        var email    by rememberSaveable { mutableStateOf(emailIn) }
        var password by rememberSaveable { mutableStateOf(pwdIn) }
        ...
        Row {
            ...
            Button(onClick = {
                navController.navigate("SignUp" + when {
